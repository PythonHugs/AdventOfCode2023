""" Puzzle 2 for Puzzle 9 for Advent of Code 2023 """
...
def main():
    # puzzle_input = read_input('part_2_puzzle_9_example_input.txt')
    puzzle_input = read_input('part_2_puzzle_9_input.txt')
    print(puzzle_input)
    print('')
